  ...
  <MarketingLayout>
    ...
    <section className="fm-mkt-hero">
      ...
      <p className="fm-mkt-sub">
        FIDMAP and Frill both cover the core feedback-to-roadmap-to-
        changelog workflow. Here's how they actually differ.
      </p>
    </section>
    ...
    <article className="fm-legal" style={{ maxWidth: 760 }}>
      <h2>What Frill is</h2>
      <p>
        Frill (frill.co) is a feedback platform built around three
        connected pieces: Ideas (a feedback board customers vote and
        comment on), a public Roadmap, and Announcements (a changelog
        widget teams can embed to tell users what shipped). Frill also
        offers NPS/CSAT survey add-ons and a widget for embedding
        announcements directly in a product.
      </p>

      <h2>What FIDMAP is</h2>
      <p>
        FIDMAP covers the same core loop — feedback boards, voting,
        comments, a public roadmap, and a changelog — under your own
        workspace portal. FIDMAP does not currently offer built-in NPS or
        CSAT surveys.
      </p>

      <h2>How pricing works</h2>
      <p>
        As of this writing, Frill's paid plans start at around $25/month
        for smaller teams, with higher tiers around $49/month and
        $149/month as team size and feature needs grow, and a 14-day free
        trial with no credit card required. Check{" "}
      ...
      <p>
        FIDMAP's plans are priced by tier (Startup, Business) with limits
        on team members, boards, feedback posts, and end users, plus a
        one-time Lifetime option — see{" "}
      ...
      <ul>
        <li>
          Frill includes optional NPS/CSAT survey add-ons; FIDMAP is
          focused on the feedback-board-to-roadmap-to-changelog workflow
          without built-in surveys.
        </li>
        <li>
      ...
      <p>
        Teams that also want NPS/CSAT surveys alongside feedback
        management may prefer Frill. Teams that want a focused
        feedback-to-roadmap-to-changelog tool, including a one-time
        Lifetime pricing option, may prefer FIDMAP.
      </p>
    </article>
